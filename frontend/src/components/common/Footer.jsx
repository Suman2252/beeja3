      ...
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-2 lg:w-[50%] mb-7 lg:pl-0">
              <img src={StudyNotionLogo} alt="" className="object-contain" />
              <h1 className="text-richblack-50 font-semibold text-[16px]">Elevate your knowledge journey with Beeja. Learn, and grow together with us!</h1>
              {/* social icons */}
          ...
          {/* Section 2 */}
          <div className="lg:w-[80%] flex flex-wrap flex-row justify-between pl-3 lg:pl-5 gap-3">
