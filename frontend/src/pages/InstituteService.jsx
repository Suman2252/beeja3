  ...
  return (
    <div className="theme-bg-primary min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/contact">
                <button className="theme-button-primary px-6 py-3 rounded-lg font-semibold hover:scale-95 transition-all duration-200 hover:shadow-lg">
                  Partner With Us
                </button>
              </Link>
              <Link to="/about">
                <button className="border border-[var(--button-primary-bg)] text-[var(--button-primary-bg)] px-6 py-3 rounded-lg font-semibold hover:bg-[var(--button-primary-bg)] hover:text-black transition-all duration-200 theme-learn-more-btn">
                  Learn More
                </button>
              </Link>
            </div>
          ...
          >
            ...
            <div className="theme-bg-secondary rounded-xl p-8 relative z-10 theme-border border theme-professional-team-border">
              <div className="flex items-center justify-center h-64 theme-professional-team-bg rounded-lg">
                <div className="text-center">
                  <FaUsers className="text-6xl text-yellow-50 mx-auto mb-4 theme-hero-icon cursor-pointer" />
                  <p className="theme-professional-team-text">Professional Team Collaboration</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="theme-bg-secondary p-6 rounded-xl theme-border border transition-all duration-300 hover:scale-105 theme-service-card"
            >
      ...
      <section id="job-requirements-bg" className="w-full theme-job-requirements-section py-20">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-semibold theme-job-requirements-heading mb-8">
          ...
          <Link to="/contact">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="theme-button-primary px-8 py-4 rounded-lg font-semibold hover:shadow-xl transition-all duration-200"
            >
              Contact Now
            </motion.button>
          </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          >
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4 p-4 theme-bg-secondary rounded-lg border-l-4 border-yellow-50 theme-yellow-border">
                <div className="w-3 h-3 bg-yellow-50 rounded-full mt-2 flex-shrink-0 theme-yellow-dot"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              {benefits.map((benefit, index) => (
                <motion.div
                  ...
                  className="theme-bg-secondary p-4 rounded-lg theme-benefit-card"
                >
      ...
      <section className="mx-auto w-11/12 max-w-maxContent py-20">
        <motion.div 
          ...
          whileInView={'show'}
          viewport={{ once: false, amount: 0.2 }}
          className="theme-ready-transform-bg rounded-2xl p-10 text-center"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact">
              <button className="bg-white text-black px-8 py-3 rounded-lg font-semibold hover:scale-95 transition-all duration-200 hover:shadow-lg">
                Start Partnership
              </button>
            </Link>
            <Link to="/about">
              <button className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-black transition-all duration-200">
                Learn More
              </button>
            </Link>
          </div>
      ...
      <footer className="institute-page-footer">
        <ImprovedFooter />
      </footer>
    </div>
  );
